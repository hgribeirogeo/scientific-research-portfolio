###-------------------------------------------------------------------------------------------------
### PROGRAMA PARA EXTRAIR GRAFICOS DAS IMAGENS DO MAPBIOMAS - Agua
###-------------------------------------------------------------------------------------------------
...
setwd("D:/ORIENTACAO/ANDRIELLY/RASTER/AGUA/")
getwd()

dir <- "D:/ORIENTACAO/ANDRIELLY/RASTER/AGUA/"
...
legenda <- read_excel("D:/ORIENTACAO/ANDRIELLY/RASTER/AGUA/Legenda_agua.xlsx")
...
ggplot(data = result2, aes(x = classes, y = Areas, fill = Ano)) +
  ...
  labs(title = "Variação das Lâminas de Água ao Longo dos Anos",
       x = "Classes", y = "Área (km²)")
